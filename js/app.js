...
var camera, controls, scene, renderer, stats, particles, running, gui, text, current, axes, activeMesh, particleMesh;
	...
	this.updateForce = function(){
		...
		for (var i=0; i < particles.length; i++){
			if (this === particles[i]){
				...
				//console.log(unitDistance.multiplyScalar(scaleDistance));
			}
		}
